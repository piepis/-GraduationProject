...
pred_model = model.construct_model("./model/ocr_plate_all_w_rnn_2.h5",) #加载训练模型
import time
...
def fastdecode(y_pred):
    ...
    res = table_pred.argmax(axis=1) #1代表沿着行的  沿轴axis最大值的索引。
